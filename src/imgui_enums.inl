...
nb::enum_<ImGuiWindowFlags_>(m, "WindowFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiChildFlags_>(m, "ChildFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiItemFlags_>(m, "ItemFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiInputTextFlags_>(m, "InputTextFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTreeNodeFlags_>(m, "TreeNodeFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiPopupFlags_>(m, "PopupFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiSelectableFlags_>(m, "SelectableFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiComboFlags_>(m, "ComboFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTabBarFlags_>(m, "TabBarFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTabItemFlags_>(m, "TabItemFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiFocusedFlags_>(m, "FocusedFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiHoveredFlags_>(m, "HoveredFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiDragDropFlags_>(m, "DragDropFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiKey>(m, "Key", nb::is_arithmetic(), "")
        ...
        .value("KEY_NAMED_KEY_BEGIN", ImGuiKey_NamedKey_BEGIN, "First valid key value (other than 0)")
        .value("KEY_TAB", ImGuiKey_Tab, "== ImGuiKey_NamedKey_BEGIN")
        ...
        .value("KEY_LEFT_SUPER", ImGuiKey_LeftSuper, "Also see ImGuiMod_Ctrl, ImGuiMod_Shift, ImGuiMod_Alt, ImGuiMod_Super below!")
        ...
        .value("KEY_BACKSLASH", ImGuiKey_Backslash, "\\ (this text inhibit multiline comment caused by backslash)")
        ...
        .value("KEY_APP_BACK", ImGuiKey_AppBack, "Available on some keyboard/mouses. Often referred as \"Browser Back")
        .value("KEY_APP_FORWARD", ImGuiKey_AppForward, "")
        .value("KEY_OEM102", ImGuiKey_Oem102, "Non-US backslash.")
        .value("KEY_GAMEPAD_START", ImGuiKey_GamepadStart, "Menu        | +       | Options  |")
        .value("KEY_GAMEPAD_BACK", ImGuiKey_GamepadBack, "View        | -       | Share    |")
        .value("KEY_GAMEPAD_FACE_LEFT", ImGuiKey_GamepadFaceLeft, "X           | Y       | Square   | Tap: Toggle Menu. Hold: Windowing mode (Focus/Move/Resize windows)")
        .value("KEY_GAMEPAD_FACE_RIGHT", ImGuiKey_GamepadFaceRight, "B           | A       | Circle   | Cancel / Close / Exit")
        .value("KEY_GAMEPAD_FACE_UP", ImGuiKey_GamepadFaceUp, "Y           | X       | Triangle | Text Input / On-screen Keyboard")
        .value("KEY_GAMEPAD_FACE_DOWN", ImGuiKey_GamepadFaceDown, "A           | B       | Cross    | Activate / Open / Toggle / Tweak")
        .value("KEY_GAMEPAD_DPAD_LEFT", ImGuiKey_GamepadDpadLeft, "D-pad Left  | \"       | \"        | Move / Tweak / Resize Window (in Windowing mode)")
        .value("KEY_GAMEPAD_DPAD_RIGHT", ImGuiKey_GamepadDpadRight, "D-pad Right | \"       | \"        | Move / Tweak / Resize Window (in Windowing mode)")
        .value("KEY_GAMEPAD_DPAD_UP", ImGuiKey_GamepadDpadUp, "D-pad Up    | \"       | \"        | Move / Tweak / Resize Window (in Windowing mode)")
        .value("KEY_GAMEPAD_DPAD_DOWN", ImGuiKey_GamepadDpadDown, "D-pad Down  | \"       | \"        | Move / Tweak / Resize Window (in Windowing mode)")
        .value("KEY_GAMEPAD_L1", ImGuiKey_GamepadL1, "L Bumper    | L       | L1       | Tweak Slower / Focus Previous (in Windowing mode)")
        .value("KEY_GAMEPAD_R1", ImGuiKey_GamepadR1, "R Bumper    | R       | R1       | Tweak Faster / Focus Next (in Windowing mode)")
        .value("KEY_GAMEPAD_L2", ImGuiKey_GamepadL2, "L Trigger   | ZL      | L2       | [Analog]")
        .value("KEY_GAMEPAD_R2", ImGuiKey_GamepadR2, "R Trigger   | ZR      | R2       | [Analog]")
        .value("KEY_GAMEPAD_L3", ImGuiKey_GamepadL3, "L Stick     | L3      | L3       |")
        .value("KEY_GAMEPAD_R3", ImGuiKey_GamepadR3, "R Stick     | R3      | R3       |")
        .value("KEY_GAMEPAD_L_STICK_LEFT", ImGuiKey_GamepadLStickLeft, "|         |          | [Analog] Move Window (in Windowing mode)")
        .value("KEY_GAMEPAD_L_STICK_RIGHT", ImGuiKey_GamepadLStickRight, "|         |          | [Analog] Move Window (in Windowing mode)")
        .value("KEY_GAMEPAD_L_STICK_UP", ImGuiKey_GamepadLStickUp, "|         |          | [Analog] Move Window (in Windowing mode)")
        .value("KEY_GAMEPAD_L_STICK_DOWN", ImGuiKey_GamepadLStickDown, "|         |          | [Analog] Move Window (in Windowing mode)")
        .value("KEY_GAMEPAD_R_STICK_LEFT", ImGuiKey_GamepadRStickLeft, "|         |          | [Analog]")
        .value("KEY_GAMEPAD_R_STICK_RIGHT", ImGuiKey_GamepadRStickRight, "|         |          | [Analog]")
        .value("KEY_GAMEPAD_R_STICK_UP", ImGuiKey_GamepadRStickUp, "|         |          | [Analog]")
        .value("KEY_GAMEPAD_R_STICK_DOWN", ImGuiKey_GamepadRStickDown, "|         |          | [Analog]")
        .value("KEY_MOUSE_LEFT", ImGuiKey_MouseLeft, " Aliases: Mouse Buttons (auto-submitted from AddMouseButtonEvent() calls)\n - This is mirroring the data also written to io.MouseDown[], io.MouseWheel, in a format allowing them to be accessed via standard key API.")
        ...
        .value("KEY_RESERVED_FOR_MOD_CTRL", ImGuiKey_ReservedForModCtrl, "[Internal] Reserved for mod storage")
...
nb::enum_<ImGuiInputFlags_>(m, "InputFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiConfigFlags_>(m, "ConfigFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiBackendFlags_>(m, "BackendFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiButtonFlags_>(m, "ButtonFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiColorEditFlags_>(m, "ColorEditFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiSliderFlags_>(m, "SliderFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTableFlags_>(m, "TableFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTableColumnFlags_>(m, "TableColumnFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiTableRowFlags_>(m, "TableRowFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiMultiSelectFlags_>(m, "MultiSelectFlags", nb::is_arithmetic(), nb::is_flag(), "")
...
nb::enum_<ImGuiSelectionRequestType>(m, "SelectionRequestType", nb::is_arithmetic(), "")
...
nb::enum_<ImDrawFlags_>(m, "DrawFlags", nb::is_arithmetic(), nb::is_flag(), "")
