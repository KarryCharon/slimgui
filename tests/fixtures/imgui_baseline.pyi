...
class FontConfig:
    ...
    @property
    def pixel_snap_v(self) -> bool: ...

    @pixel_snap_v.setter
    def pixel_snap_v(self, arg: bool, /) -> None: ...
...
class PlatformImeData:
    """Platform IME data for io.platform_set_ime_data_fn() function."""
...
class SelectionRequest:
    """A selection request from BeginMultiSelect()/EndMultiSelect()."""

    @property
    def type(self) -> SelectionRequestType:
        """Request type."""

    @property
    def selected(self) -> bool:
        """Parameter for SetAll/SetRange (true=select, false=unselect)."""

    @property
    def range_direction(self) -> int:
        """+1 forward, -1 backward."""

    @property
    def range_first_item(self) -> int:
        """First item for SetRange request."""

    @property
    def range_last_item(self) -> int:
        """Last item for SetRange request (inclusive)."""

class MultiSelectIO:
    """Main IO structure returned by BeginMultiSelect()/EndMultiSelect()."""

    @property
    def requests(self) -> Iterator[SelectionRequest]:
        """Selection requests to process."""

    @property
    def range_src_item(self) -> int:
        """Source item that must not be clipped."""

    @range_src_item.setter
    def range_src_item(self, arg: int, /) -> None: ...

    @property
    def nav_id_item(self) -> int:
        """Last known SetNextItemSelectionUserData() value for NavId."""

    @nav_id_item.setter
    def nav_id_item(self, arg: int, /) -> None: ...

    @property
    def nav_id_selected(self) -> bool:
        """Whether NavId item is currently selected."""

    @nav_id_selected.setter
    def nav_id_selected(self, arg: bool, /) -> None: ...

    @property
    def range_src_reset(self) -> bool:
        """Set before EndMultiSelect() to reset RangeSrcItem."""

    @range_src_reset.setter
    def range_src_reset(self, arg: bool, /) -> None: ...

    @property
    def items_count(self) -> int:
        """items_count passed to BeginMultiSelect()."""

class SelectionBasicStorage:
    """Optional helper to store multi-selection state."""
    ...
    def preserve_order(self, arg: bool, /) -> None: ...

    def get_adapter_index_to_storage_id(self) -> object: ...

    def set_adapter_index_to_storage_id(self, fn: object | None = None) -> None: ...
    ...
    def swap(self, other: SelectionBasicStorage) -> None: ...

    def set_item_selected(self, id: int, selected: bool) -> None: ...

    def get_storage_id_from_index(self, idx: int) -> int: ...
...
class SelectionExternalStorage:
    """Optional helper to apply multi-selection requests to existing storage."""

    def __init__(self) -> None: ...

    def get_adapter_set_item_selected(self) -> object: ...

    def set_adapter_set_item_selected(self, fn: object | None = None) -> None: ...
...
class SizeCallbackData:
    """Callback data for SetNextWindowSizeConstraints()."""
    ...
    @property
    def desired_size(self) -> tuple[float, float]:
        """
        Desired size, based on mouse position. Write to this field to restrain resizing.
        """

    @desired_size.setter
    def desired_size(self, arg: tuple[float, float], /) -> None: ...

class InputTextCallbackData:
    """Shared state of InputText() when using custom callback."""

    @property
    def event_flag(self) -> InputTextFlags:
        """
        One of ImGuiInputTextFlags_Callback* indicating which event triggered the callback.
        """
    ...
    @cursor_pos.setter
    def cursor_pos(self, arg: int, /) -> None: ...
    ...
    def selection_start(self, arg: int, /) -> None: ...
    ...
    def selection_end(self, arg: int, /) -> None: ...
    ...
    def insert_chars(self, pos: int, text: str) -> None:
        """Insert text at position pos. Resets selection."""
...
class DrawList:
    ...
    def path_stroke(self, col: int, flags: DrawFlags = DrawFlags.NONE, thickness: float = 1.0) -> None: ...
    ...
    def path_rect(self, rect_min: tuple[float, float], rect_max: tuple[float, float], rounding: float = 0.0, flags: DrawFlags = DrawFlags.NONE) -> None: ...
...
class Key(enum.IntEnum):
    ...
    KEY_BACKSLASH = 604
    r"""\ (this text inhibit multiline comment caused by backslash)"""
...
class InputFlags(enum.IntFlag):
    ...
    """
    Option: global route: will not be applied if underlying background/None is focused (== no Dear ImGui windows are focused). Useful for overlay applications.
    """
...
def set_next_window_size_constraints_internal(size_min: tuple[float, float], size_max: tuple[float, float], cb: Callable | None = None) -> None:
    ...
...
@overload
def combo(label: str, current_item: int, getter: Callable, items_count: int, popup_max_height_in_items: int = -1) -> tuple[bool, int]:
    ...
...
@overload
def list_box(label: str, current_item: int, getter: Callable, items_count: int, height_in_items: int = -1) -> tuple[bool, int]:
    ...
...
def is_item_toggled_selection() -> bool:
    """Was the last item selection state toggled? Useful if you need the per-item information _before_ reaching `end_multi_select()`. We only returns toggle _event_ in order to handle clipping correctly."""
    ...
...
@overload
def plot_lines(label: str, values_getter: Callable, values_count: int, values_offset: int = 0, overlay_text: str | None = None, scale_min: float = FLT_MAX, scale_max: float = FLT_MAX, graph_size: tuple[float, float] = (0.0, 0.0)) -> None:
    ...
...
@overload
def plot_histogram(label: str, values_getter: Callable, values_count: int, values_offset: int = 0, overlay_text: str | None = None, scale_min: float = FLT_MAX, scale_max: float = FLT_MAX, graph_size: tuple[float, float] = (0.0, 0.0)) -> None:
    ...
...
def input_text(label: str, text: str, flags: InputTextFlags = InputTextFlags.NONE, callback: Callable | None = None) -> tuple[bool, str]:
    ...


def input_text_with_hint(label: str, hint: str, text: str, flags: InputTextFlags = InputTextFlags.NONE, callback: Callable | None = None) -> tuple[bool, str]:
    ...


def input_text_multiline(label: str, text: str, size: tuple[float, float] = (0.0, 0.0), flags: InputTextFlags = InputTextFlags.NONE, callback: Callable | None = None) -> tuple[bool, str]:
    ...
...
@overload
def value(prefix: str, v: float, float_format: str | None = None) -> None:
    ...
